# Django settings for araghor project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'araghor', # Or path to database file if using sqlite3.
...
SECRET_KEY = 'is=g3lvc14iwr5%y%qk&106^jexv%1xv66!yd%un1u9o0r&w#4'
